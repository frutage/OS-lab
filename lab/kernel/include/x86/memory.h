...
#define SEG_VIDEO   6
#define SEG_CHILD_UCODE  7
#define SEG_CHILD_UDATA  8
...
struct processTable {
	...
	struct TrapFrame tf;          //form ring3 to ring0
	int state;              //porcess state
	int timeCount;		//Running time
        int sleepTime;		//blocked time
